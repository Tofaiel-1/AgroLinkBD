              ...
              sliver: SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    PremiumSectionTitle(
                      title: 'সাম�?প�?রতিক লেনদেন',
                      onSeeAll: () {},
                    ),
                    const PremiumTransactionCard(
                      title: 'ট�?রিপ #TR2024-05810',
                      date: 'আজ, সকাল ৯:১৫',
                      amount: '৳ 1,850',
                      isCredit: true,
                      status: 'Completed',
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Get.snackbar('ইতিহাস', 'সব ট�?রিপ দেখ�?ন');
                          },
                          child: const Text('সব দেখ�?ন'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 12),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('????: ${_activeTrip!['pickup']}', style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey.shade600)),
                    const SizedBox(height: 2),
                    Text('???: ${_activeTrip!['delivery']}', style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey.shade600)),
                  ],
                ),
              ),
              Text(
